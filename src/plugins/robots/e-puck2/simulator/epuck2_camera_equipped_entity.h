/**
 * @file <argos3/plugins/robots/e-puck2/simulator/epuck2_camera_equipped_entity.h>
 *
...
#ifndef EPUCK2_CAMERA_EQUIPPED_ENTITY_H
#define EPUCK2_CAMERA_EQUIPPED_ENTITY_H
...
namespace argos {
   ...
   class CEPuck2CameraEquippedEntity : public CEntity {
   ...
   public:
       ...
       */
      CEPuck2CameraEquippedEntity(CComposableEntity* pc_parent);
