/**
 * @file <argos3/plugins/robots/e-puck2/simulator/dynamics2d_epuck2_model.cpp>
 *
...
#include "dynamics2d_epuck2_model.h"
...
namespace argos {
   ...
   CDynamics2DEPuck2Model::CDynamics2DEPuck2Model(CDynamics2DEngine& c_engine,
   ...
   CDynamics2DEPuck2Model::~CDynamics2DEPuck2Model() {
   ...
   void CDynamics2DEPuck2Model::Reset() {
   ...
   void CDynamics2DEPuck2Model::UpdateFromEntityStatus() {
      /* Do we want to move? */
   ...
   REGISTER_STANDARD_DYNAMICS2D_OPERATIONS_ON_ENTITY(CEPuck2Entity, CDynamics2DEPuck2Model);
