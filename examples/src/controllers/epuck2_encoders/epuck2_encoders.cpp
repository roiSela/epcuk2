...
CCI_EPuck2Light::CCI_EPuck2Light() :
   m_pcWheels(NULL),
...
void CCI_EPuck2Light::Init(TConfigurationNode& t_node) {
...
void CCI_EPuck2Light::ControlStep() {
...
REGISTER_CONTROLLER(CCI_EPuck2Light, "epuck2_encoders_controller")
